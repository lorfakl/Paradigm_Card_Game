...
{
    [Header("Players")]
    public Player2 TopPlayer;
    public Player2 LowPlayer;
    [Header("Colors")]
    ...
    public Dictionary<AreaPosition, Player2> Players = new Dictionary<AreaPosition, Player2>();
    ...
    public bool CanControlThisPlayer(Player2 ownerPlayer)
    {
    ...
    public void EnableEndTurnButtonOnStart(Player2 P)
    {
